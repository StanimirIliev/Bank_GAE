...
import com.clouway.bank.adapter.gcp.pubsub.PubsubDispatcher
...
class AppBootstrap {
    fun start() {
        ...
        // create pubsub topic
        val topicName = TopicName.of("bank-e-corp", "user-event-handler")
        val pubsubDispatcher = PubsubDispatcher(topicName)
        // init observer
