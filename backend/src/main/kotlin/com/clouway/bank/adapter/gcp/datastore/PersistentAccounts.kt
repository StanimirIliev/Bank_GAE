...
import com.clouway.bank.core.ErrorType.INCORRECT_ID
...
class PersistentAccounts(
    ...
    override fun updateBalance(accountId: Long, userId: Long, amount: Float): OperationResponse {
        ...
        transactions.registerTransaction(Transaction(userId, accountId, LocalDateTime.now(),
